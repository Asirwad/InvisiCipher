...
def hide_image(cover_image_filepath, secret_image_filepath):
    ...
    secret_image_in = np.array(Image.open(secret_image_filepath).convert('RGB')).reshape(1, 224, 224, 3) / 255.0
    cover_image_in = np.array(Image.open(cover_image_filepath).convert('RGB')).reshape(1, 224, 224, 3) / 255.0
